...
#     netlist_ = netlist_from_numpy_directory('test/dataset1/small')
...
#     print(netlist_.net_tree.children_dict)
#     print(netlist_.net_tree.path_dict)
#     print(netlist_.net_offset_pos_matrix.to_dense())
#     print(netlist_.pin_net_matrix.to_dense())
#     print(netlist_.pin_cell_matrix.to_dense())
